 ...
 *
 */
public class dependencyToolException extends dependencyToolClientException {
	private static final long serialVersionUID = 1L;
	
	/**
	 * no arguments constructor
	 */
	public dependencyToolException() {
		super();
	}
	 ...
	 *            message for client.
	 */
	public dependencyToolException(Throwable t, String domain, String code, int status, String debugMessage,
	 ...
	 *            message for client.
	 */
	public dependencyToolException(String domain, String code, int status, String debugMessage, String clientMessage) {
