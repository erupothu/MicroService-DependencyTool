...
public class dependencyToolExceptionHandler implements ResponseErrorHandler {
	...
	public void handleError(ClientHttpResponse response) throws IOException {
		...
		throw new dependencyToolClientExceptionBuilder().responseToException(errorResponse);
	}
