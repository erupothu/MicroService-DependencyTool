...
public class NEJSONEventLayoutV1 extends Layout {
	 ...
	 *            messages.
	 */
	public NEJSONEventLayoutV1(boolean locationInfo) {
	...
	public String format(LoggingEvent loggingEvent) {
		...
		try {
			if (org.slf4j.MDC.get("customLog") != null) {
				log = mapper.readValue(org.slf4j.MDC.get("customLog"), CustomLog.class);
				logstashEvent.put("customLog", log);
			}
