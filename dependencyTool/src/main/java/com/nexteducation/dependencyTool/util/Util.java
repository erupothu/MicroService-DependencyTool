...
public class Util {
	...
	public static ModelAndView handleModelError(ModelAndView modelAndView, final Exception exception) {
		...
		if (exception instanceof dependencyToolException) {
	...
	public static String getMd5Hash(final String string) throws dependencyToolException {
		try {
			...
			throw new dependencyToolException("NextSevice","md5HashError",500,"Error occured while hasing","Error occured while hasing");
		}
	}
}
